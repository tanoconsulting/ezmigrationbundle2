...
class GenerateTest extends CommandExecutingTest
{
    ...
    public function provideGenerateParameters()
    {
        $out = array(
            ...
            array('unit_test_generated_content', null, 'content', 'content_type_identifier', 'user_group'),
            array('unit_test_generated_content', 'yml', 'content', 'content_type_identifier', 'user_group', false, 'update'),
            array('unit_test_generated_content', 'json', 'content', 'content_type_identifier', 'user_group', false, 'delete'),
            ...
            array('unit_test_generated_content_type_group', null, 'content_type_group', 'content_type_group_identifier', 'Content'),
            array('unit_test_generated_content_type_group', 'yml', 'content_type_group', 'content_type_group_identifier', 'Content', false, 'update'),
            array('unit_test_generated_content_type_group', 'json', 'content_type_group', 'content_type_group_identifier', 'Content', false, 'delete'),
            ...
            array('unit_test_generated_object_state_group', null, 'object_state_group', 'object_state_group_identifier', 'ez_lock'),
            array('unit_test_generated_object_state_group', 'yml', 'object_state_group', 'object_state_group_identifier', 'ez_lock', false, 'update'),
            array('unit_test_generated_object_state_group', 'json', 'object_state_group', 'object_state_group_identifier', 'ez_lock', false, 'delete'),
        ...
        $container = $this->getBootedContainer() == null ? $this->bootContainer() : $this->getBootedContainer();
